...
;(function (root) {
  ...
  function buildBanner() {
    ...
    // Title
    var title = el('h3', { className: 'nuvo-cc-banner__title' }, _cfg.bannerTitle);
  ...
  function buildPreferences() {
    ...
    var title = el('h2', { className: 'nuvo-cc-modal__title' }, _cfg.modalTitle);
    var desc = el('p', { className: 'nuvo-cc-modal__desc' });
    desc.innerHTML = _cfg.modalDesc + ' Read our <a href="' + _cfg.policyUrl + '" target="_blank" rel="noopener">Privacy Policy</a>.';
    ...
    Object.keys(cats).forEach(function (key) {
      ...
      var label = el('div', { className: 'nuvo-cc-category__label' }, cat.label);
      var catDesc = el('div', { className: 'nuvo-cc-category__desc' }, cat.description);
      info.appendChild(label);
      info.appendChild(catDesc);

      if (cat.required) {
        var badge = el('span', { className: 'nuvo-cc-badge' }, 'Always on');
